...
/*
 ...
 摘录来自: Apple Inc. “The Swift Programming Language (Swift 3.1)”。 iBooks.
 “You can use this optional return value to check whether the optional chaining call was successful (the returned optional contains a value), or did not succeed due to a nil value in the chain (the returned optional value is nil).”
...
/*
 “If you try to access numberOfRooms with the same optional chaining as before, it will now return an Int? that contains the default numberOfRooms value of 1:”
...
/*
 “Because leo.residence is nil, this optional chaining call fails in the same way as before.
...
/*
 “The optional chaining question mark in this subscript call is placed immediately after leo.residence, before the subscript brackets, because leo.residence is the optional value on which optional chaining is being attempted.”
...
/*
 “If you create and assign an actual Residence instance to leo.residence, with one or more Room instances in its rooms array, you can use the Residence subscript to access the actual items in the rooms array through optional chaining:”
...
/*
 “The example below tries to access the street property of the address property of the residence property of leo. There are two levels of optional chaining in use here, to chain through the residence and address properties, both of which are of optional type:”
...
/*
 “The value of leo.residence currently contains a valid Residence instance. However, the value of leo.residence.address is currently nil. Because of this, the call to leo.residence?.address?.street fails.”

 摘录来自: Apple Inc. “The Swift Programming Language (Swift 3.1)”。 iBooks.
 */

/*
 “If you set an actual Address instance as the value for leo.residence.address, and set an actual value for the address’s street property, you can access the value of the street property through multilevel optional chaining:”
